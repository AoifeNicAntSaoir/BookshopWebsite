...
<div id="box1">
    <h3 style="text-shadow: 1px 1px gray; text-align: center; ">Refine <span style="text-shadow: 1px 1px gray;" class="highlight">Book Details</span></h3>
     <?php
...
else
{
  ...
  echo "<p style='text-align: center;'><em>Sorry, no books currently available.</em></p><img style='height: 250px; margin-left: 35%;' src='error.png'>";
exit();  }
else
{ 

echo("<table>");
echo("<tr><th>Book ID</th> <th>Book Name:</th><th>Author:</th><th>Price:</th></tr>");
while ( $row = mysqli_fetch_array($res) ) {


echo("<tr><td>". $row['bookid']. "</td><td>". stripslashes($row['bookname'] ). "</td><td>". stripslashes($row['author'] ). "</td><td>". stripslashes($row['price'] ). "</td></tr>");
