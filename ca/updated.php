...
if ( !$res ) {
  ...
  {
echo "<p style='text-align: center;'>Record Updated</p><br> <a style='margin-left: 35%; color: orange; text-shadow: 1px 1px gray;' href='Update/Remove.php'>Click here to update/remove another book</a>";}
  mysqli_close($dbcnx);
}
?>
</div>
